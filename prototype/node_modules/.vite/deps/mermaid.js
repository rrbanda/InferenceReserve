import {
  selectSvgElement
} from "./chunk-SAT4HWGK.js";
import {
  clearLayoutRenderState,
  createCommonLayoutRenderer,
  defaultMeasureLayout,
  paintLayoutData
} from "./chunk-KIQHR5YK.js";
import "./chunk-TKIRVWWT.js";
import {
  JSON_SCHEMA,
  load
} from "./chunk-S5TQBL4R.js";
import {
  registerLayoutLoaders
} from "./chunk-46P7UX3N.js";
import "./chunk-VBVJRS7L.js";
import "./chunk-SFHNCIZU.js";
import "./chunk-LDW6DV2M.js";
import "./chunk-B6QCJT6M.js";
import "./chunk-TKVCLTZM.js";
import "./chunk-TNWHCC6S.js";
import {
  dedent
} from "./chunk-BUQO27E2.js";
import {
  registerIconPacks
} from "./chunk-F7KVKGK4.js";
import {
  cleanAndMerge,
  decodeEntities,
  encodeEntities,
...
import {
  ...
  themes_default,
  updateSiteConfig
} from "./chunk-ATDJJA4D.js";
import {
  log,
  select_default,
  setLogLevel
} from "./chunk-JWBPW3VL.js";
import {
  __name
...
var loader = __name(async () => {
  const { diagram: diagram2 } = await import("./c4Diagram-7LVT6UL2-XK73GK4K.js");
...
var loader2 = __name(async () => {
  const { diagram: diagram2 } = await import("./flowDiagram-HODETNUW-EKHSEQUR.js");
...
var loader4 = __name(async () => {
  const { diagram: diagram2 } = await import("./swimlanesDiagram-VR7AAH4N-GW6KYCSY.js");
...
var loader5 = __name(async () => {
  const { diagram: diagram2 } = await import("./erDiagram-RLTQ6QDP-YOTWMMU4.js");
...
var loader6 = __name(async () => {
  const { diagram: diagram2 } = await import("./gitGraphDiagram-WWUBYQGX-6Y2STAB5.js");
...
var loader7 = __name(async () => {
  const { diagram: diagram2 } = await import("./ganttDiagram-EL5Y4UJY-LSUTNCPY.js");
...
var loader8 = __name(async () => {
  const { diagram: diagram2 } = await import("./infoDiagram-27XIBGKW-HNQJRQJ3.js");
...
var loader9 = __name(async () => {
  const { diagram: diagram2 } = await import("./pieDiagram-E7YTZNPT-UCZOMGSU.js");
...
var loader10 = __name(async () => {
  const { diagram: diagram2 } = await import("./quadrantDiagram-AXDQQJYC-OGZ5EJCQ.js");
...
var loader11 = __name(async () => {
  const { diagram: diagram2 } = await import("./xychartDiagram-S5SC5T6Z-JXBN6SUT.js");
...
var loader12 = __name(async () => {
  const { diagram: diagram2 } = await import("./requirementDiagram-BXWQKSXE-3GHZZBL2.js");
...
var loader13 = __name(async () => {
  const { diagram: diagram2 } = await import("./sequenceDiagram-WJ2MYXX4-BYSAHBSF.js");
...
var loader14 = __name(async () => {
  const { diagram: diagram2 } = await import("./classDiagram-ZZMXUADV-D7W2ZIEF.js");
...
var loader15 = __name(async () => {
  const { diagram: diagram2 } = await import("./classDiagram-v2-VYDZK3BY-NGWDE2GL.js");
...
var loader16 = __name(async () => {
  const { diagram: diagram2 } = await import("./stateDiagram-D77RDMKH-QWJ2B5IA.js");
...
var loader17 = __name(async () => {
  const { diagram: diagram2 } = await import("./stateDiagram-v2-MP3YSRHH-HNJPVR55.js");
...
var loader18 = __name(async () => {
  const { diagram: diagram2 } = await import("./journeyDiagram-3NMN7TZE-7ZTWGT22.js");
...
var loader20 = __name(async () => {
  const { diagram: diagram2 } = await import("./timeline-definition-24CTP7MA-MGXUKCMX.js");
...
var loader21 = __name(async () => {
  const { diagram: diagram2 } = await import("./mindmap-definition-YA3MSWOX-5QD63D3J.js");
...
var loader22 = __name(async () => {
  const { diagram: diagram2 } = await import("./kanban-definition-UXKFOSKX-XQBCP3QW.js");
...
var loader23 = __name(async () => {
  const { diagram: diagram2 } = await import("./sankeyDiagram-P5KCCOFB-USMYKKS5.js");
...
var loader24 = __name(async () => {
  const { diagram: diagram2 } = await import("./diagram-Z3DM3KII-RS3T7C7M.js");
...
var loader25 = __name(async () => {
  const { diagram: diagram2 } = await import("./diagram-UQ7AKVKN-WHZWUHLC.js");
...
var loader26 = __name(async () => {
  const { diagram: diagram2 } = await import("./blockDiagram-I7D4REHJ-SOA7R6X5.js");
...
var loader27 = __name(async () => {
  const { diagram: diagram2 } = await import("./diagram-S7CK7UJ4-VHH4M6PZ.js");
...
var loader28 = __name(async () => {
  const { diagram: diagram2 } = await import("./architectureDiagram-5GKGNRK7-IXFJVALU.js");
...
var loader29 = __name(async () => {
  const { diagram: diagram2 } = await import("./diagram-VSXAHHWV-QMVH65M3.js");
...
var loader30 = __name(async () => {
  const { diagram: diagram2 } = await import("./ishikawaDiagram-5VMMS53U-TQRPXB4J.js");
...
var loader31 = __name(async () => {
  const { diagram: diagram2 } = await import("./vennDiagram-4TSXK5OY-RQFDZGNY.js");
...
var loader32 = __name(async () => {
  const { diagram: diagram2 } = await import("./diagram-VX7I27RA-EFSFLWWS.js");
...
var loader33 = __name(async () => {
  const { diagram: diagram2 } = await import("./wardleyDiagram-VM6X3IG4-NZSOP3LN.js");
...
var loader34 = __name(async () => {
  const { diagram: diagram2 } = await import("./cynefinDiagram-5FMLGOSQ-SRPCF4YT.js");
...
var loader35 = __name(async () => {
  const { diagram: diagram2 } = await import("./railroadDiagram-O6MQD6OU-TXRIB6AC.js");
...
var loader36 = __name(async () => {
  const { diagram: diagram2 } = await import("./ebnfDiagram-PWID7BFC-3WQQHIQL.js");
...
var loader37 = __name(async () => {
  const { diagram: diagram2 } = await import("./abnfDiagram-VCTEODGH-LNEZBO3G.js");
...
var loader38 = __name(async () => {
  const { diagram: diagram2 } = await import("./pegDiagram-XKGWAZYB-DM6ZF2O5.js");
...
var render = __name(async function(id39, text, svgContainingElement) {
  ...
  try {
    if (false) {
      await profiler.span("draw", () => diag.renderer.draw(text, id39, "11.17.2", diag));
    } else {
      await diag.renderer.draw(text, id39, "11.17.2", diag);
    }
  } catch (e) {
    if (config.suppressErrorRendering) {
      removeTempElements();
    } else {
      errorRenderer_default.draw(text, id39, "11.17.2");
    }
    throw e;
  }
