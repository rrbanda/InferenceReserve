...
| PM-13 | Vertex PT's 1-week commitment term is commercially viable for our on-prem PT | Low | Open | Vertex added 1-week terms in 2026 for spike events. On-prem node assignment has higher overhead than cloud provisioning. 1-week terms may not justify the node taint/untaint cycle. Evaluate in Phase 2. |
